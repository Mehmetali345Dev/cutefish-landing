...
export default function Desktop() {
  ...
  return (
    <div className="md:flex grid md:rounded-none rounded-md justify-between w-full items-center px-8 md:px-32 py-8 bg-gradient-to-r from-green-300 to-indigo-300">
